...
// PHẦN: TV-05 — Xác thực JWT
// MÔ TẢ: Middleware này chạy TRƯỚC mọi route cần bảo vệ.
//        Đọc token từ header "Authorization: Bearer <token>"
//        Nếu hợp lệ → gắn req.user và cho đi tiếp (next())
//        Nếu không  → trả 401 ngay, không vào controller
// ============================================================
